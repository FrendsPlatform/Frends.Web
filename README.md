...
| Use Cookie Container             | bool                            | If UseCookieContainer is set to false, using manually set header cookies. Otherwise using Cookie Container. Default value is true. |
